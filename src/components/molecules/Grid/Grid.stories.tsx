...
export const AutoFlow: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 32 }}>
      <div style={{ flex: 1 }}>
        <StoryCaption>autoFlow: 'row' (default)</StoryCaption>
        <StoryContainer gap={2}>
      ...
      <div style={{ flex: 1 }}>
        <StoryCaption>autoFlow: 'column'</StoryCaption>
        <StoryContainer autoFlow="column" gap={2}>
          <GridItem>Item 1</GridItem>
          <GridItem>Item 2</GridItem>
          <GridItem>Item 3</GridItem>
        </StoryContainer>
...
export const AutoColumns: Story = {
  render: () => (
    <StoryContainer autoColumns="200px" templateRows="1fr 1fr" gap={2}>
      <GridItem>Item 1</GridItem>
      <GridItem>Item 2</GridItem>
      <GridItem>Item 3</GridItem>
    </StoryContainer>
...
export const AutoRows: Story = {
  render: () => (
    <StoryContainer autoRows="100px" templateColumns="repeat(3, 1fr)" gap={2}>
      <GridItem>Item 1</GridItem>
      <GridItem>Item 2</GridItem>
      <GridItem>Item 3</GridItem>
    </StoryContainer>
