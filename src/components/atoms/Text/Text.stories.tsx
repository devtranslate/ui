      ...
      <StoryContainer>
        {tags.map((item) => (
          <div key={item.tag}>
            ...
            <Text as={item.tag}>The quick brown fox jumps over the lazy dog</Text>
          </div>
        ))}
      </StoryContainer>
    );
      ...
      <StoryContainer>
        {colors.map((color) => (
          <div key={color}>
            ...
            <Text color={`${color}[600]`}>The quick brown fox jumps over the lazy dog</Text>
          </div>
        ))}
      </StoryContainer>
    );
      ...
      <StoryContainer>
        {letterSpacings.map((spacing) => (
          <div key={spacing}>
            ...
            <Text letterSpacing={spacing}>The quick brown fox jumps over the lazy dog</Text>
          </div>
        ))}
      </StoryContainer>
    );
      ...
      <StoryContainer>
        {textTransform.map((transform) => (
          <div key={transform}>
            ...
            <Text textTransform={transform}>The quick brown fox jumps over the lazy dog</Text>
          </div>
        ))}
      </StoryContainer>
    );
      ...
      <StoryContainer>
        {textAlign.map((align) => (
          <div key={align}>
            ...
            <Text textAlign={align}>The quick brown fox jumps over the lazy dog</Text>
          </div>
        ))}
      </StoryContainer>
    );
...
export const LineClamp: Story = {
  render: () => {
    return (
      <StoryContainer>
        <Text lineClamp={2}>{simpleText}</Text>
      </StoryContainer>
    );
  }
};
